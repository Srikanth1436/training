...
/*
pay2(lp2){
  this.presentedData = JSON.parse(localStorage.getItem('ordersdata'));
     if(this.presentedData) {
       this.presentedData.push(lp2);
       localStorage.setItem('ordersdata',JSON.stringify(this.presentedData));
